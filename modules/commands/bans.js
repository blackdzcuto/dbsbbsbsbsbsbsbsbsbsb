  ...
  */
  if(!bans.warns.hasOwnProperty(threadID)) {
	...
	var dtwbox = bans.warns[threadID];
  		...
  		allwarn == "" ? api.sendMessage({body: "Nhóm bạn chưa có ai bị ban.",attachment: (await axios.get((await axios.get(`https://randomlinkapi.YeutrucvclTrucd.repl.co/images/canh`)).data.data, {
                    responseType: 'stream'
