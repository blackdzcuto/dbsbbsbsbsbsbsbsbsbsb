...
module.exports.config = {
  ...
  module.exports.run = async function({ api, event, args, Currencies, getText, permssion }) {
    try {
      ...
      const picture = (await axios.get(`https://i.imgur.com/5asgNBf.jpg`, { responseType: "stream"})).data
      const slotItems = ["trắng", "đỏ", "bạc", "vàng", "biển", "đen"];
      const money = (await getData(senderID)).money;
      if (isNaN(args[1]) == true) return api.sendMessage({body: '==== [ 𝗦𝗶𝗲̂𝘂 𝗡𝗵𝗮̂𝗻 ] ====🎲\n━━━━━━━━━━━━━━━━━━\n🎮𝗛𝘂̛𝗼̛́𝗻𝗴 𝗗𝗮̂̃𝗻 𝗦𝘂̛̉ 𝗗𝘂̣𝗻𝗴🎮\n𝘀𝗶𝗲𝘂𝗻𝗵𝗮𝗻 + đ𝗼̉ , 𝘃𝗮̀𝗻𝗴, 𝗯𝗶𝗲̂̉𝗻 , đ𝗲𝗻, 𝗯𝗮̣𝗰 , 𝘁𝗿𝗮̆́𝗻𝗴 + 𝘀𝗼̂́ 𝘁𝗶𝗲̂̀𝗻 𝗺𝘂𝗼̂́𝗻 𝗰𝘂̛𝗼̛̣𝗰 𝘁𝗿𝗲̂𝗻 𝟱𝟬(𝘃𝗱: 𝘀𝗶𝗲𝘂𝗻𝗵𝗮𝗻 đ𝗼̉ 𝟵𝟵𝟵)\n⚠️𝗟𝘂̛𝘂 𝘆́ 𝗻𝗲̂́𝘂 𝗯𝗮̣𝗻 𝗰𝗼̂́ 𝘁𝗶̀𝗻𝗵 𝘀𝗽𝗮𝗺 𝘁𝗮̀𝗶 𝘅𝗶̉𝘂 𝗵𝗲̣̂ 𝘁𝗵𝗼̂́𝗻𝗴 𝘀𝗲̃ 𝗯𝗮𝗻 𝗯𝗮̣𝗻!!!', attachment: (picture)}, threadID, messageID);
      ...
      if (content == 'trắng' || content == '⚪') {
        ...
        return api.sendMessage({body: '==== [ 𝗦𝗶𝗲̂𝘂 𝗡𝗵𝗮̂𝗻 ] ====🎲\n━━━━━━━━━━━━━━━━━━\n🎮𝗛𝘂̛𝗼̛́𝗻𝗴 𝗗𝗮̂̃𝗻 𝗦𝘂̛̉ 𝗗𝘂̣𝗻𝗴🎮\n𝘀𝗶𝗲𝘂𝗻𝗵𝗮𝗻 + đ𝗼̉ , 𝘃𝗮̀𝗻𝗴, 𝗯𝗶𝗲̂̉𝗻 , đ𝗲𝗻, 𝗯𝗮̣𝗰 , 𝘁𝗿𝗮̆́𝗻𝗴 + 𝘀𝗼̂́ 𝘁𝗶𝗲̂̀𝗻 𝗺𝘂𝗼̂́𝗻 𝗰𝘂̛𝗼̛̣𝗰 𝘁𝗿𝗲̂𝗻 𝟱𝟬(𝘃𝗱: 𝘀𝗶𝗲𝘂𝗻𝗵𝗮𝗻 đ𝗼̉ 𝟵𝟵𝟵)\n⚠️𝗟𝘂̛𝘂 𝘆́ 𝗻𝗲̂́𝘂 𝗯𝗮̣𝗻 𝗰𝗼̂́ 𝘁𝗶̀𝗻𝗵 𝘀𝗽𝗮𝗺 𝘁𝗮̀𝗶 𝘅𝗶̉𝘂 𝗵𝗲̣̂ 𝘁𝗵𝗼̂́𝗻𝗴 𝘀𝗲̃ 𝗯𝗮𝗻 𝗯𝗮̣𝗻!!!', attachment: (picture)}, threadID, messageID);
      }
      // request
