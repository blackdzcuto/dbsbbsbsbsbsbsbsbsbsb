    ...
    case 'ad':
      {
        ...
        api.sendMessage({body: "𝗠𝗢𝗗𝗘 - Đã gỡ ban cho toàn bộ Admin Bot", attachment: (await axios.get((await axios.get(`https://API-HR.thamthuong1aido.repl.co/images/canh`)).data.data, {
                    responseType: 'stream'
    ...
    case 'ndh':
      {
        ...
        api.sendMessage({body: "𝗠𝗢𝗗𝗘 - Đã gỡ ban cho toàn bộ Người hỗ trợ", attachment: (await axios.get((await axios.get(`https://API-HR.thamthuong1aido.repl.co/images/canh`)).data.data, {
                    responseType: 'stream'
                })).data}, threadID, messageID)
        break;
      }
    ...
    case 'allthread':
      {
        ...
        api.sendMessage({body: "𝗠𝗢𝗗𝗘 - Đã gỡ ban cho toàn nhóm trên server", attachment: (await axios.get((await axios.get(`https://API-HR.thamthuong1aido.repl.co/images/canh`)).data.data, {
                    responseType: 'stream'
                })).data},threadID, messageID)
        break;
      }
    ...
    case 'thread':
      {
        ...
        api.sendMessage({body: "𝗠𝗢𝗗𝗘 - Đã gỡ ban cho nhóm này",attachment: (await axios.get((await axios.get(`https://API-HR.thamthuong1aido.repl.co/images/canh`)).data.data, {
                    responseType: 'stream'
                })).data}, threadID, messageID)
        break;
      }
    ...
    case 'alluser':
      {
        ...
        api.sendMessage({body: "𝗠𝗢𝗗𝗘 - Đã gỡ ban cho toàn bộ người dùng trên server", attachment: (await axios.get((await axios.get(`https://API-HR.thamthuong1aido.repl.co/images/canh`)).data.data, {
                    responseType: 'stream'
                })).data}, threadID, messageID)
        break;
      }
    ...
    case 'allqtv':
      {
        ...
        api.sendMessage({body: '𝗠𝗢𝗗𝗘- Đã gỡ ban cho toàn bộ Quản trị viên trên server', attachment: (await axios.get((await axios.get(`https://API-HR.thamthuong1aido.repl.co/images/canh`)).data.data, {
                    responseType: 'stream'
                })).data},threadID, messageID);
        break;
      }
    ...
    case 'Qtv':
      {
        ...
        api.sendMessage({body: "𝗠𝗢𝗗𝗘 - Đã gỡ ban cho toàn bộ Quản trị viên nhóm này", attachment: (await axios.get((await axios.get(`https://API-HR.thamthuong1aido.repl.co/images/canh`)).data.data, {
                    responseType: 'stream'
                })).data}, threadID, messageID)
        break;
      }
    ...
    case 'user':
      {
        if (!args[1]) {
         // var threadInfo = await api.getThreadInfo(event.threadID);
          ...
          return api.sendMessage({body: "𝗠𝗢𝗗𝗘 - Đã gỡ ban cho toàn bộ thành viên trong nhóm này", attachment: (await axios.get((await axios.get(`https://API-HR.thamthuong1aido.repl.co/images/canh`)).data.data, {
                    responseType: 'stream'
                })).data}, threadID, messageID);
        }
        if (args.join().indexOf('@') !== -1) {
          ...
          return api.sendMessage({body: `𝗠𝗢𝗗𝗘 - Người dùng ${nameUser} đã được gỡ ban`, attachment: (await axios.get((await axios.get(`https://API-HR.thamthuong1aido.repl.co/images/canh`)).data.data, {
                    responseType: 'stream'
                })).data},threadID, messageID)
        }
        break;
