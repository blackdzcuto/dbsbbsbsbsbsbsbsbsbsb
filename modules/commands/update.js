module.exports.config = {
    name: "updatett", // Tên lệnh, được sử dụng trong việc gọi lệnh
    ...
    commandCategory: "Economy", // Thuộc vào nhóm nào: system, other, game-sp, game-mp, random-img, edit-img, media, economy, ...
...
const anh = (await axios.get(`https://i.imgur.com/bgqF00t.jpg`, { responseType: "stream"})).data
