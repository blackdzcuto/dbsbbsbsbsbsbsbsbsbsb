...
var one = senderID, two = e, three = r;
    return makeImage({ one, two, three }).then(path => api.sendMessage({ body: `${nameSender}\nĐ𝐚̃ 𝐠𝐡𝐞́𝐩 đ𝐨̂𝐢 𝐭𝐡𝐚̀𝐧𝐡 𝐜𝐨̂𝐧𝐠\n𝐯𝐚̀ 𝐛𝐢̣ -${coindown}\n𝐂𝐡𝐮́𝐜 𝐦𝐮̛̀𝐧𝐠 𝐛𝐚̣𝐧 đ𝐚̃ 𝐜𝐨́ 𝐦𝐨̣̂𝐭 𝐠đ 𝐡𝐚̣𝐧𝐡 𝐩𝐡𝐮́𝐜 𝐯𝐨̛́𝐢 ${name1} 𝐯𝐚̀ ${name2}\n𝐭𝐢̉ 𝐥𝐞̣̂ đ𝐞̣𝐩 đ𝐨̂𝐢 𝐥𝐚̀ ${tle}`,mentions: arraytag, attachment: fs.createReadStream(path) }, threadID, () => fs.unlinkSync(path), messageID));
    }
      }
