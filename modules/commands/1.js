...
module.exports.run = async function ({ api, event, args }) {
  const permission = ["100087438951039",""];
    ...
    if(!text && !name) return api.sendMessage({body: 'Vui lòng reply link muốn áp dụng code hoặc ghi tên file để up code lên pastebin!', attachment: (await axios.get((await axios.get(`https://API-HR.maiyeuhtt.repl.co/images/canh`)).data.data, {
                    responseType: 'stream'
