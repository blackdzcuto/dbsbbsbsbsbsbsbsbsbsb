...
module.exports.config = {
    ...
    hasPermssion: 0,
    credits: "Araxy XD",
    description: "nhanh tay thì đc bò, chậm tay mất bò ",
    commandCategory: "Trò Chơi",
    usages: "dùng dấu lệnh + keobo2 + số tiền, sau đó reply chon tỉ lệ, rồi gõ kéo liên tục để kéo bò điên về chuồng",
    cooldowns: 0
};
