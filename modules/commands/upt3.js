...
let l1 = await loadImage(pathAva);
  ...
  ctx.drawImage(l1, -350, -100, 1200, 1200);
    ...
    ctx.fillText("Tuan Hai", 1095, 440);
    ctx.beginPath();
  ////////////////////////////////////////
...
registerFont(__dirname + `/tad/CaviarDreams.ttf`, {
    ...
    ctx.textAlign = "start";
    ctx.font = "45px time";
    ctx.fillText("@" + "Phùng Tuấn Hải", 1180, 615)
    ctx.fillText("@" + "pth_mika", 1180, 685)
   ctx.fillText("@" + "Tuanhaidz", 1180, 750)
    ctx.restore();
    ctx.save();
    ctx.beginPath();
