...
const path = join(__dirname, "cache", "antiout","randomgif");
  ...
  api.addUserToGroup(event.logMessageData.leftParticipantFbId, event.threadID, (error, info) => {
   if (error) {
    api.sendMessage({body: `━━━━『 𝐓𝐢𝐧 𝐍𝐡𝐚̆́𝐧 𝐇𝐞̣̂ 𝐓𝐡𝐨̂́𝐧𝐠 』━━━━\n『 𝐊𝐢́𝐜𝐡 𝐇𝐨𝐚̣𝐭  』     ➣ 𝐂𝐡𝐨̂́𝐧𝐠 𝐓𝐡𝐚̀𝐧𝐡 𝐕𝐢𝐞̂𝐧 𝐑𝐨̛̀𝐢 𝐁𝐨𝐱\n『 𝐓𝐢̀𝐧𝐡 𝐓𝐫𝐚̣𝐧𝐠  』   ➣ 𝐓𝐡𝐞̂𝐦 𝐓𝐡𝐚̂́𝐭 𝐁𝐚̣𝐢 𝐓𝐡𝐚̀𝐧𝐡 𝐕𝐢𝐞̂𝐧 𝐕𝐚̀𝐨 𝐁𝐨𝐱\n『    𝐔𝐬𝐞𝐫 𝐑𝐨̛̀𝐢    』   ➣  ${name}\n『   𝐓𝐡𝐨̛̀𝐢 𝐆𝐢𝐚𝐧   』   ➣  ${timeNow} || ${thu}`, attachment: createReadStream(gifPath) },event.threadID)
   } else api.sendMessage({body:`━━━━『 𝐓𝐢𝐧 𝐍𝐡𝐚̆́𝐧 𝐇𝐞̣̂ 𝐓𝐡𝐨̂́𝐧𝐠 』━━━━
『 𝐊𝐢́𝐜𝐡 𝐇𝐨𝐚̣𝐭  』     ➣ 𝐂𝐡𝐨̂́𝐧𝐠 𝐓𝐡𝐚̀𝐧𝐡 𝐕𝐢𝐞̂𝐧 𝐑𝐨̛̀𝐢 𝐁𝐨𝐱
『 𝐓𝐢̀𝐧𝐡 𝐓𝐫𝐚̣𝐧𝐠  』   ➣ 𝐓𝐡𝐞̂𝐦 𝐓𝐡𝐚̀𝐧𝐡 𝐂𝐨̂𝐧𝐠 𝐓𝐡𝐚̀𝐧𝐡 𝐕𝐢𝐞̂𝐧 𝐕𝐚̀𝐨 𝐁𝐨𝐱
『    𝐔𝐬𝐞𝐫 𝐑𝐨̛̀𝐢    』   ➣  ${name}
『   𝐓𝐡𝐨̛̀𝐢 𝐆𝐢𝐚𝐧   』   ➣  ${timeNow} || ${thu}`,attachment: createReadStream(gifhh) }, event.threadID);
  })
 }
}