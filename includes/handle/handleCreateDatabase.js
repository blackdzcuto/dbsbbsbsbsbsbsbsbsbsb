    ...
    return async function ({ event }) {
        ...
        try {
            if (!allThreadID.includes(threadID) && event.isGroup == !![]) {
                ...
                for (singleData of threadIn4.userInfo) {
                    ...
                    try {
                        ...
                        logger(global.getText('handleCreateDatabase', 'newUser', singleData.id), '[ 𝐇𝐚𝐫𝐢𝐧 ]'));
                    } catch(e) { console.log(e) };
                }
                logger(global.getText('handleCreateDatabase', 'newThread', threadID), '[ 𝐇𝐚𝐫𝐢𝐧 ]');
            }
            if (!allUserID.includes(senderID) || !userName.has(senderID)) {
                ...
                logger(global.getText('handleCreateDatabase', 'newUser', senderID), '[ 𝐇𝐚𝐫𝐢𝐧 ]');
            }
