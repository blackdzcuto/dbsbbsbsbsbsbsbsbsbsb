  ...
  setInterval(async() => {
    ...
    if (day != day_now) {
      ...
      checkttData.forEach(async(checkttFile) => {
        ...
        api.sendMessage({body: checkttBody,attachment: fsfs.createReadStream(__dirname + `/../modules/commands/thongtin/ad.gif`)},  checkttFile.replace('.json', ''), (err) => err ? console.log(err) : '');
...
(async function () {
  ...
  const handleUnsend = require("./handle/handleUnsend")({ api });
	...
	return async (event) => {
	  if (event.type == "change_thread_image") api.sendMessage({body: `=== 『 𝗖𝗔̣̂𝗣 𝗡𝗛𝗔̣̂𝗧 𝗡𝗛𝗢́𝗠 』 ====\n━━━━━━━━━━━━━━━━━━\n\n➝ ${event.snippet}\n➝ 𝗩𝗮̀𝗼 𝗹𝘂́𝗰: ${timeNow} || ${thu}`, attachment: (await global.nodemodule["axios"]({
url: (await global.nodemodule["axios"]('https://API-HR.maiyeuhtt.repl.co/hai/images/canh')).data.url,
method: "GET",
responseType: "stream"
})).data                                      },event.threadID);
    ...
    var ngay = moment.tz('Asia/Ho_Chi_Minh').format('dddd');
  if (ngay == 'Sunday') ngay = '𝐂𝐡𝐮̉ 𝐍𝐡𝐚̣̂𝐭'
  if (ngay == 'Monday') ngay = '𝐓𝐡𝐮̛́ 𝐇𝐚𝐢'
  if (ngay == 'Tuesday') ngay = '𝐓𝐡𝐮̛́ 𝐁𝐚'
  if (ngay == 'Wednesday') ngay = '𝐓𝐡𝐮̛́ 𝐓𝐮̛'
  if (ngay == "Thursday") ngay = '𝐓𝐡𝐮̛́ 𝐍𝐚̆𝐦'
  if (ngay == 'Friday') ngay = '𝐓𝐡𝐮̛́ 𝐒𝐚́𝐮'
  if (ngay == 'Saturday') ngay = '𝐓𝐡𝐮̛́ 𝐁𝐚̉𝐲'
...
[🏆] ➝ 𝗡𝗵𝗼́𝗺:\n${threadName}  
[🔥] ➝ 𝗧𝗜𝗗:\n${event.threadID}
𝗰𝗵𝘂̛𝗮 đ𝘂̛𝗼̛̣𝗰 𝗮𝗱𝗺𝗶𝗻 𝗱𝘂𝘆𝗲̣̂𝘁.Đ𝗲̂̉ 𝗴𝘂̛̉𝗶 𝘆𝗲̂𝘂 𝗰𝗮̂̀𝘂 𝗱𝘂𝘆𝗲̣̂𝘁, 𝗱𝘂̀𝗻𝗴: ${prefix}duyetbox\n[💓] ➝ 𝗧𝗵𝗶́𝗻𝗵: ${tpk}\n[⏰] ➝ 𝗛𝗶𝗲̣̂𝗻 𝘁𝗮̣𝗶 𝗯𝗼𝘁 đ𝗮̃ 𝗼𝗻𝗹𝗶𝗻𝗲 đ𝗰 ${anh} 𝗴𝗶𝗼̛̀ ${la} 𝗽𝗵𝘂́𝘁 ${vtoan} 𝗴𝗶𝗮̂𝘆\n━━━━━━━━━━━━━━━━\n====「${time} || ${ngay}」====`, attachment: (await global.nodemodule["axios"]({
url: (await global.nodemodule["axios"]('https://API-HR.maiyeuhtt.repl.co/hai/images/canh')).data.url,
method: "GET",
responseType: "stream"
})).data
...
url: (await global.nodemodule["axios"]('https://API-HR.maiyeuhtt.repl.co/images/canh')).data.data,
method: "GET",
responseType: "stream"
})).data                                      }, event.threadID);
        }
